...
@section('content')
<div>
    <h1 class="font-1 mt-5">Buat Objek Wisata</h1>
</div>
    ...
    <form action="{{route('admin.wisata.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <div class="col-xl-6 mt-5">
                ...
                <input required type="text" name="wisata" class="form-control" id="wisata" aria-describedby="wisata" placeholder="Nama Objek Wisata">
            </div>
