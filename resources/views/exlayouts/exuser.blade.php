            ...
            <div class="container pt-5 pb-5 pr-2 pl-2">
              <div class="row">
                ...
                <div class="col-xl-3 mt-5">
                  ...
                  <hr>
                  @if (count($membershipakreditasis) > 0)
                  @foreach ($membershipakreditasis as $membershipakreditasi)
                      @if ($membershipakreditasi->kategori == 'accreditedBy')
                        <a href="{{$membershipakreditasi->url}}">
                          <img class="mr-2 mt-2" width="80" src="{{asset('storage/membership_akreditasi')}}/{{$membershipakreditasi->gambar}}" alt="">
                        </a>
                      @endif
                  @endforeach
                  @endif
                ...
                <div class="col-xl-3 mt-5">
                  ...
                  @if (count($membershipakreditasis) > 0)
                    @foreach ($membershipakreditasis as $membershipakreditasi)
                        @if ($membershipakreditasi->kategori == 'membership')
                          <a href="{{$membershipakreditasi->url}}">
                            <img class="mr-2 mt-2" width="80" src="{{asset('storage/membership_akreditasi')}}/{{$membershipakreditasi->gambar}}" alt="">
                          </a>
                        @endif
